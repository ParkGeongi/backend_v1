...
class DetectFace:
    def __init__(self, image):
        ...
        self.predictor = dlib.shape_predictor('../../utils/weights/shape_predictor_68_face_landmarks.dat')
    ...
    def detect_face_part(self):
        face_parts = [[],[],[],[],[],[],[],[]]
        # detect faces in the grayscale test
        ...
        for (name, (i, j)) in face_utils.FACIAL_LANDMARKS_IDXS.items():
            ...
            #print(f'{idx}----------{face_parts[idx]}')
            idx += 1
        face_parts = face_parts[1:5]
        # set the variables
        # Caution: this coordinates fits on the RESIZED test.
